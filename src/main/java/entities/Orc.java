...
public class Orc extends Creature{
    ...
    public Orc(int worldWidth, int worldHeight) {
        super(new Coordinates(0, 0), worldWidth, worldHeight);
    }

    public Orc(Coordinates coordinates, int worldWidth, int worldHeight) {
        super(coordinates, worldWidth, worldHeight);
    }
